...
instructions = pygame.image.load("Game Data\\instructions.png")
instructions = pygame.transform.scale(instructions, (800, 400)).convert_alpha()
apple = pygame.image.load("Game Data\\food.png")
apple = pygame.transform.scale(apple, (13, 13)).convert_alpha()
blueorb = pygame.image.load("Game Data\\orb.png")
blueorb = pygame.transform.scale(blueorb, (12, 12)).convert_alpha()
purpleberry = pygame.image.load("Game Data\\berry.png")
purpleberry = pygame.transform.scale(purpleberry, (12, 12)).convert_alpha()
...
playertheme = 'Game Data\\snake.mp3'
...
def howtoplay():
    ...
    while r2 == True and g_exit == False:
        ...
        button_c2 = gameWindow.blit(button_c2, (190, 323))
...
def instruct():
    ...
    g_exit = False
    r9 = True 
    while r9 == True and g_exit == False:
        gameWindow.fill(white)
        gameWindow.blit(instructions, (0, 0))
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                g_exit = True
            if event.type == pygame.KEYDOWN:
...
def char_info():
    ...
    while r6 == True and g_exit == False:
        ...
        b_default = gameWindow.blit(b_default, (280, 100))
        b_viper = pygame.image.load("Game Data\\b_viper.png")
        b_viper = pygame.transform.scale(b_viper, (250, 50)).convert_alpha()
        b_viper = gameWindow.blit(b_viper, (280, 260))
        b_kobra = pygame.image.load("Game Data\\b_kobra.png")
        b_kobra = pygame.transform.scale(b_kobra, (250, 50)).convert_alpha()
        b_kobra = gameWindow.blit(b_kobra, (280, 200))
        b_python = pygame.image.load("Game Data\\b_python.png")
        b_python = pygame.transform.scale(b_python, (250, 40)).convert_alpha()
        b_python = gameWindow.blit(b_python, (280, 150))
        button_h = pygame.image.load("Game Data\\button_h.png")
        button_h = pygame.transform.scale(button_h, (30, 30)).convert_alpha()
        button_h = gameWindow.blit(button_h, (760, 350))
        button_i = pygame.image.load("Game Data\\button_i.png")
        ...
        if click:
            ...
            if b_default.collidepoint((mx, my)): 
                ...
                click = False
                individualchar()
            if b_viper.collidepoint((mx, my)):
                charforinfo = 'Game Data\\m_viper.png'
                click = False
                individualchar()
            if b_kobra.collidepoint((mx, my)):
                charforinfo = 'Game Data\\m_kobra.png'
                click = False
                individualchar()
            if b_python.collidepoint((mx, my)):
                charforinfo = 'Game Data\\m_python.png'
                click = False
                individualchar()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
...
def char_sel():
    ...
    start_chartime = 0
    g_exit = False
    characters = ['Snake', 'Viper', 'Kobra', 'Python']
    if play_m == False and music_n == True:
        pygame.mixer.music.pause()
    ...
    while r7 == True and g_exit == False:
        ...
        button_default = pygame.transform.scale(button_default, (180, 90)).convert_alpha()
        button_default = gameWindow.blit(button_default, (210, 160))
        button_viper = pygame.image.load("Game Data\\viper.png")
        button_viper = pygame.transform.scale(button_viper, (180, 90)).convert_alpha()
        button_viper = gameWindow.blit(button_viper, (520, 270))
        button_kobra = pygame.image.load("Game Data\\kobra.png")
        button_kobra = pygame.transform.scale(button_kobra, (180, 90)).convert_alpha()
        button_kobra = gameWindow.blit(button_kobra, (330, 270))
        button_python = pygame.image.load("Game Data\\python.png")
        button_python = pygame.transform.scale(button_python, (180, 90)).convert_alpha()
        button_python = gameWindow.blit(button_python, (140, 270))
        button_random = pygame.image.load("Game Data\\random.png")
        button_random = pygame.transform.scale(button_random, (180, 90)).convert_alpha()
        button_random = gameWindow.blit(button_random, (420, 160))
        if click:
            if button_default.collidepoint((mx, my)):
                character = 'Snake'
                start_chartime = time.time()
                click = False
            if button_viper.collidepoint((mx, my)):
                character = 'Viper'
                start_chartime = time.time()
                click = False
            if button_kobra.collidepoint((mx, my)):
                character = 'Kobra'
                start_chartime = time.time()
                click = False
            if button_python.collidepoint((mx, my)):
                character = 'Python'
                start_chartime = time.time()
                click = False
        ...
        if char_diff <= 5:
            ...
            text_screen2(str(5-char_diff) ,white,393,140)
        if char_diff == 5:
            instruct()
...
def gameloop():
    ...
    if character == 'Snake':
        ...
        playertheme = "Game Data\\viper.mp3"   
    elif character == 'Kobra':
        playertheme = "Game Data\\kobra.mp3" 
    elif character == 'Python':
        playertheme = "Game Data\\python.mp3"   
    home_y = False
    berry_choose = True
    ...
    while not g_exit:
        ...
        if game_over:
            ...
            if character == 'Snake':
                ...
                snakeface = "Game Data\\c_viper.png"
                face = pygame.transform.scale(face, (30, 30)).convert_alpha()
            elif character == 'Kobra':
                snakeface = "Game Data\\c_kobra.png"
                face = pygame.transform.scale(face, (25, 25)).convert_alpha()
            elif character == 'Python':
                snakeface = "Game Data\\c_python.png"
                face = pygame.transform.scale(face, (25, 23)).convert_alpha()
            ...
            if poison_berry != 'poison_berry':
                gameWindow.blit(blueorb,(power_x,power_y))
            elif poison_berry == "poison_berry":
                gameWindow.blit(purpleberry,(berry_x,berry_y))
